package com.jung.competence.service;
...
public interface UserCompetenceService extends JqueryGridService {
	//插入新的用户角色
    ...
    //删除角色、角色关联的菜单、用户关联的角色
	public void deleteRoleForUser(Integer roleID,Integer useID);
	...
	*/
	public void deleteCMByS(List<ViewMenuTree> vmtl, Integer parseInt);
	//通过菜单ID批量获取菜单
