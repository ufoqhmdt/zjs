...
<%@include file="/commons/jsp/common_header.jsp"%>
	<div class="contain">
		<s:form action="employee/add.action" method="post">
		<div class="search">
			<div align="right">
				</div>
			<fieldset >
				...
				<div align="center">
					...
					<s:textfield name="employee.employeeName"></s:textfield>
				</div>
				<div align="center">
					<label><s:text name="代表类型"></s:text></label>
					<s:select name="employee.employeeType" list="#{1:'MR',2:'DSM',3:'PS',4:'MARKET'}"  label="abc" listKey="key" listValue="value"  headerKey="0" headerValue=""/>
				</div>
				<div align="center">
					<label><s:text name="代表手机"></s:text></label>
					<s:textfield name="employee.employeeMobile"></s:textfield>
				</div>
				<div align="center">
					<label><s:text name="所在地区"></s:text></label>
					<s:hidden name="regionID" id="regionID"></s:hidden>
					<s:textfield name="employee.region.regionName" onclick="regionSelect()" readonly="true" id="regionName"></s:textfield>
				</div>
			
				<div align="center">
					<label><s:text name="代表编号"></s:text></label>
					<s:textfield name="employee.employeeNumber"></s:textfield>
				</div>
				<div align="center">
					<label><s:text name="上级代表"></s:text></label>
					<s:hidden name="parentEmployeeID" id="parentEmployeeID"></s:hidden>
					<s:textfield name="employee.parentEmployee.employeeName" readonly="true" onclick="parentEmployeeSelect()" id="parentEmployeeName"></s:textfield>
				</div>
				<div align="center">
